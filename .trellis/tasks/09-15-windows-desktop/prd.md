...
- Follow-up: audit business paths with mocked remote APIs, reproduce concrete
  allocation, collection, Yuba, config and credential/cache bugs, and fix verified
  defects while preserving intended task semantics.
